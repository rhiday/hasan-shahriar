...
export default function ResumePage() {
  ...
  return (
    <>
      ...
      />
      <main
        className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:mx-auto print:max-w-[7.2in] print:origin-top-left print:scale-[0.9] print:overflow-visible print:p-5 print:text-[12px] print:leading-tight md:p-16"
        id="main-content"
      >
